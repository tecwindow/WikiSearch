...
OutputDir=D:\python\жнян»нѕн«\dist\ahm
...
[Files]
Source: "D:\python\жнян»нѕн«\dist\WikiSearch\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\python\жнян»нѕн«\dist\WikiSearch\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
